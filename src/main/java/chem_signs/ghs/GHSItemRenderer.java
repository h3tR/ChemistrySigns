...
public class GHSItemRenderer extends TileEntityItemStackRenderer {
    ...
    public void renderByItem(ItemStack itemStackIn) {
        ...
        //top left
        buffer.pos(0 , .5, -1/16F).tex(0, .5+1/8F).endVertex();
        buffer.pos(-.5, 0, -1/16F).tex(.5, .5+1/8F).endVertex();
        buffer.pos(-.5, 0, 0).tex(.5, .5).endVertex();
        buffer.pos(0 , .5, 0).tex(0, .5).endVertex();

        //bottom left
        buffer.pos(-.5, 0, -1/16F).tex(0, .5+1/8F).endVertex();
        buffer.pos(0, -.5, -1/16F).tex(.5, .5+1/8F).endVertex();
        buffer.pos(0, -.5, 0).tex(.5, .5).endVertex();
        buffer.pos(-.5, 0, 0).tex(0, .5).endVertex();
        //bottom right
        buffer.pos(0, -.5, -1/16F).tex(0, .5+1/8F).endVertex();
        buffer.pos(.5, 0 , -1/16F).tex(.5, .5+1/8F).endVertex();
        buffer.pos(.5, 0 , 0).tex(.5, .5).endVertex();
